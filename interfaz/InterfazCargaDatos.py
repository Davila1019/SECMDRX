...
class VentanaDatos:
    def __init__(self):
        ...
        self.ventana_cargadatos.iconbitmap("../resourses/images/logo-ipn.ico")
        ...
        self.bg = PhotoImage(file="images/Fondo3.png")

        canvas1 = Canvas(self.ventana_cargadatos, width=850,
                              height=300)
        ...
        bg_azul = '#249794'  # Azul
        image_add = PhotoImage(file='../resources/images/icons/cil-plus.png')
        image_res = PhotoImage(file='../resources/images/icons/cil-x.png')
        label_titulo = ttk.Label(self.ventana_cargadatos, font="black", text="Agregar picos de difracción ",
                                      background="white",
                                      foreground=bg_azul)
        btn_agregar = tk.Button(self.ventana_cargadatos, text="+", image=image_add, command=self.Evento_agregar,
                                     width=50, height=20,
        ...
        label_angstrom = ttk.Label(self.ventana_cargadatos, font="black", text="Valor de Ángstrom",
                                        background="white",
                                        foreground=bg_azul)
        btn_aceptar = tk.Button(self.ventana_cargadatos, text="Aceptar", command=self.Evento_aceptar, width=12,
                                     height=1,
                                     background="#249794", foreground="white")
        btn_cancelar = tk.Button(self.ventana_cargadatos, text="Cancelar", command=exit, width=12, height=1,
                                      background="#249794", foreground="white")
        # Eliminar Externo
        self.btn_eliminar = tk.Button(self.ventana_cargadatos, image=image_res, command=self.Evento_eliminar, width=50,
                                      height=20,
                                      background="#249794", foreground="white")
    ...
    def Evento_aceptar(self):
        ...
        if self.click == 6:
            if validate_notNull(self.entry_pico.get()) \
                ...
                self.ventana_graficos.show_Window()
            else:
                pass
